...
//項目3 左下-------------------------------------------------------------------
        ...
        if (BBSWItem3 == 1) {
            ...
            this.drawText(info.savecount, rect.x + rect.width - 554 + BBSWTF3 -80, y2 - 2, 266 - BBSWTF3, 'right');
        } else if (BBSWItem3 == 6) {
...
//項目5 上部-------------------------------------------------------------------
        ...
        if (BBSWItem5 == 1) {
            this.drawText(info.title, rect.x - L5 + rect.width-8, rect.y, L5, 'right');//rect.x + 455, rect.y, 312,
        } else if (BBSWItem5 == 2) {
            this.drawText(info.playtime, rect.x - L5 + rect.width -8, rect.y, L5, 'right');
        } else if (BBSWItem5 == 3) {
            this.drawText(info.mapname, rect.x - L5 + rect.width -8, rect.y, L5, 'right');
        } else if (BBSWItem5 == 4) {
            this.drawText(info.gold + TextManager.currencyUnit, rect.x - L5 + rect.width -8, rect.y, L5, 'right');
        } else if (BBSWItem5 == 5) {
            this.drawText(info.savecount, rect.x - L5 + rect.width -8, rect.y, L5, 'right');
        } else if (BBSWItem5 == 6) {
            this.drawText(info.value1 + BBSWV1u, rect.x - L5 + rect.width -8, rect.y, L5, 'right');
        } else if (BBSWItem5 == 7) {
            this.drawText(info.value2 + BBSWV2u, rect.x - L5 + rect.width -8, rect.y, L5, 'right');
        } else if (BBSWItem5 == 8) {
            this.drawText(info.value3 + BBSWV3u, rect.x - L5 + rect.width -8, rect.y, L5, 'right');
        } else if (BBSWItem5 == 9) {
            this.drawText(info.value4 + BBSWV4u, rect.x - L5 + rect.width -8, rect.y, L5, 'right');
        }
    }
};
